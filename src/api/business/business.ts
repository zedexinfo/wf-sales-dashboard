...
const getBranchTxnList = (
  ...
  return {getBranchList,putOutletStatus,getBranchTxnList}};
export type GetBranchListResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getBusiness>['getBranchList']>>>
export type PutOutletStatusResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getBusiness>['putOutletStatus']>>>
export type GetBranchTxnListResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getBusiness>['getBranchTxnList']>>>
